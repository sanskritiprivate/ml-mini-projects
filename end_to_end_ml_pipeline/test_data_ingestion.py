...
# you’re telling it to connect to a LocalStack instance running
# on your computer instead. LocalStack emulates AWS services locally,
# so this setup lets you create buckets, upload files, and test
